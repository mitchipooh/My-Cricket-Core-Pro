...
import { Organization, UserProfile, PlayerWithContext, OrgMember, OrgApplication, Team, Player, MatchFixture } from '@shared/types';
import { Can } from '@shared/components/common/Can.tsx';
import { PlayerProfileModal } from '@shared/components/modals/PlayerProfileModal.tsx';
import { EditOrgModal } from '@shared/components/modals/EditOrgModal.tsx';
import { BulkActionModal } from '@shared/components/modals/BulkActionModal.tsx';
import { AddPlayerModal } from '@shared/components/modals/AddPlayerModal.tsx';
import { UserProfileModal } from '@shared/components/modals/UserProfileModal.tsx';
import { AddMemberModal } from '@shared/components/modals/AddMemberModal.tsx';
import { GlobalTeamSearchModal } from '@shared/components/modals/GlobalTeamSearchModal.tsx';
import { EditTeamModal } from '@shared/components/modals/EditTeamModal.tsx';
import { EditTournamentModal } from '@shared/components/modals/EditTournamentModal.tsx';
import { Tournament } from '@shared/types';
import { CreateUserModal } from '@shared/components/modals/CreateUserModal.tsx'; // NEW
...
export const OrganizationView: React.FC<Partial<OrganizationViewProps>> = ({
    organization, userRole = 'Fan', onBack = () => {}, onViewTournament = () => {}, onViewPlayer = () => {},
    onRequestAddTeam = () => {}, onRequestAddTournament = () => {}, players = [], onViewTeam = () => {},
    isFollowed = false, onToggleFollow = () => {}, globalUsers = [], onAddMember = () => {}, onUpdateOrg = () => {}, onRemoveTeam = () => {}, onRemoveTournament = () => {}, onUpdateTournament = () => {}, onRemoveFixture = () => {}, onProcessApplication = () => {},
