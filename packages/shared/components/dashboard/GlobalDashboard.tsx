...
import { Organization, UserProfile, MatchFixture, PlayerWithContext } from '@shared/types';
import { OrgCard } from '@shared/components/admin/OrgCard.tsx';
import { Can } from '@shared/components/common/Can.tsx';
import { ApplicationModal } from '@shared/components/modals/ApplicationModal.tsx';
...
export const GlobalDashboard: React.FC<GlobalDashboardProps> = ({
  ...
  following = { teams: [], players: [], orgs: [] }, onToggleFollow, onRequestCaptainHub, showCaptainHub, onRequestMatchReports, onOpenCaptainHub,
  onViewOrg = () => {}, onCreateUser, onRequestTransferMarket = () => {}, globalUsers = [],
  onRemoveFixture
}) => {
