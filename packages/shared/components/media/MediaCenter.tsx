...
import { MatchFixture, Team, MediaPost, PlayerWithContext, UserProfile, Organization, Standing } from '@shared/types';
...
export const MediaCenter: React.FC<Partial<MediaCenterProps>> = ({
    onBack = () => {}, fixtures = [], teams = [], players = [], mediaPosts = [], onAddMediaPost = () => {}, onDeletePost = () => {}, onUpdatePost = () => {}, initialMatchId,
    following = { teams: [], players: [], orgs: [] }, onToggleFollow = () => {}, onViewTeam = () => {}, onViewPlayer = () => {}, userRole = 'Fan', currentProfile, organizations = [],
