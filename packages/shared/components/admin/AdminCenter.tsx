...
import { Organization, MatchFixture, UserProfile, Team, Player, Tournament, TournamentFormat, PlayerWithContext, Group, MediaPost, OrgMember, GameIssue } from '@shared/types';
import { generateRoundRobin } from '@shared/utils/cricket-engine.ts';
import { GlobalDashboard } from '../dashboard/GlobalDashboard.tsx';
import { OrganizationView } from '../dashboard/OrganizationView.tsx';
import { DEFAULT_POINTS_CONFIG, PRESET_TEST } from '@shared/competition/pointsEngine.ts';
import { TournamentDashboard } from '../dashboard/TournamentDashboard.tsx';
import { DeleteOrgModal } from '@shared/components/modals/DeleteOrgModal.tsx';
...
import { CreateOrgModal } from '@shared/components/modals/CreateOrgModal.tsx';
import { IssueResolutionModal } from '@shared/components/modals/IssueResolutionModal.tsx';
import { EmbedCodeModal } from '@shared/components/modals/EmbedCodeModal.tsx';
...
export const AdminCenter: React.FC<Partial<AdminProps>> = ({
  organizations = [], standaloneMatches = [], userRole = 'Fan', onStartMatch = () => {}, onViewMatch = () => {}, onRequestSetup = () => {},
  ...
  following = { teams: [], players: [], orgs: [] }, onToggleFollow = () => {}, mockGlobalUsers = [], onAddMemberToOrg = () => { }, onProcessApplication = () => {}, hireableScorers = [],
  currentUserId, onApplyForOrg = () => {}, onUpgradeProfile = () => {}, onTransferPlayer = () => {}, currentUserProfile,
  showCaptainHub = false, onOpenCaptainHub = () => {}, onRequestMatchReports = () => {}, onUpdateProfile = () => {},
