...
import { MatchFixture, PointsConfig } from '@shared/types';
import { calculatePointsForSide, MatchScoringPayload } from '@shared/utils/pointsCalculator';

import { DEFAULT_POINTS_CONFIG } from '@shared/competition/pointsEngine';
